...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6">
    ...
    <a class="group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#">
      ...
      <div>
        <div>
          <h3 class="block font-bold text-gray-800 dark:text-white">Crea tu propio perfil</h3>
          <p class="text-gray-600 dark:text-neutral-400">La mejor manera para publicar, descubrir y guardar peliculas.</p>
        </div>
    ...
    <a class="group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#">
      ...
      <div>
        <div>
          <h3 class="block font-bold text-gray-800 dark:text-white">Tendencias en el mercado</h3>
          <p class="text-gray-600 dark:text-neutral-400">Averigua que peliculas / series se encuentran en tendendia.</p>
        </div>
